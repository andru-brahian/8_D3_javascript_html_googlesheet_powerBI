...
d3.json("https://raw.githubusercontent.com/andru-brahian/7_D3_javascript_html_googlesheet_powerBI/main/base_datos_diagrama_velas.json")
.then(function(data) {
...
async function main() {
  ...
  const jsonDataLink = "https://raw.githubusercontent.com/andru-brahian/7_D3_javascript_html_googlesheet_powerBI/main/base_datos_diagrama_velas.json";  // Al principio tarda un poco en cargar cuando el repositorio es el mismo del link, y recien se cargó el repositorio, es cuestion de cargar varias veces o esperar
